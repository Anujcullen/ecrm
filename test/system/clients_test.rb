...
class ClientsTest < ApplicationSystemTestCase
  ...
  test "creating a Client" do
    ...
    fill_in "Expiration date", with: @client.expiration_date
    fill_in "First name", with: @client.first_name
    fill_in "Last name", with: @client.last_name
    fill_in "Phone", with: @client.phone
    fill_in "Policy effective", with: @client.policy_effective
    fill_in "Policy type", with: @client.policy_type
    fill_in "Premium", with: @client.premium
